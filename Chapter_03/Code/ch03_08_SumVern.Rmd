...
This dataframe is generated in script 7 (vernalization) in folder worked data

```{r}
#df_CumTTvern <- read.table("df_CumVern.txt",header=TRUE)

 df_CumTTvern <-read.table(paste0(workDPath,"df_CumTTvern.txt"),header=TRUE)
...
write.table(df_tempVern,paste0(workDPath, "df_tempVern.txt"))
