...
tt_card %>%
 ...
 # labs(y="Vernalization-day (0-1)") +
 # ylim(0,max(tt_card$TT))
  geom_line()+
theme_bw()+
ylim(0,1)+
xlab(expression(Temperature~"("^"o"*"C)"))+
  ylab("Vernalization-day (0-1)")+
...
ggsave(paste0(workDPath,"ch03_03_VernModel.tiff"),width=8, height=6,dpi = 300)
...
write.table(df_CumTTvern,paste0(workDPath, "df_CumTTvern.txt"))
